/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.typegen.vars` (hash: a36c1a5f64e10eab443992a1be964d9e)
// Runtime types generated with workerd@1.20260811.1 2026-08-16 
interface __BaseEnv_Env {
	USER: DurableObjectNamespace<import("./src/index").UserServer>;
	PARTY: DurableObjectNamespace<import("./src/index").SocialPartyServer>;
	MATCHMAKER: DurableObjectNamespace<import("./src/index").MatchmakerServer>;
	GAME: DurableObjectNamespace<import("./src/index").GameServer>;
	BOTCHAT: DurableObjectNamespace<import("./src/index").BotChatServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserServer" | "SocialPartyServer" | "MatchmakerServer" | "GameServer" | "BotChatServer";
	}
